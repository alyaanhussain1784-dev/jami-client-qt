    ...
    flickableContent: ColumnLayout {
        ...
        ColumnLayout {
            ...
            function isComplete() {
                ...
                var colorTheme = UtilsAdapter.getAppValue(Settings.Key.AppColorTheme);
                if (colorTheme === "Emerald") {
                    emeraldThemeButton.checked = true;
                } else if (colorTheme === "Purple") {
                    purpleThemeButton.checked = true;
                } else {
                    blueThemeButton.checked = true;
                }
            }
            ...
            Flow {
                ...
                MaterialRadioButton {
                    ...
                    width: 165
                    height: 60
                    backgroundColor: JamiTheme.radioBackgroundColor
                    textColor: JamiTheme.textColor
                    checkedColor: "#03B9E9"
                    borderColor: "#03B9E9"

                    text: "Classic Blue"
                    ButtonGroup.group: colorThemeGroup

                    onCheckedChanged: {
                        if (checked)
                            UtilsAdapter.setAppValue(Settings.Key.AppColorTheme, "Blue");
                    }
                }

                MaterialRadioButton {
                    id: emeraldThemeButton
                    ...
                    onCheckedChanged: {
                        if (checked)
                            UtilsAdapter.setAppValue(Settings.Key.AppColorTheme, "Emerald");
                    }
                }

                MaterialRadioButton {
                    id: purpleThemeButton
                    ...
                    onCheckedChanged: {
                        if (checked)
                            UtilsAdapter.setAppValue(Settings.Key.AppColorTheme, "Purple");
                    }
                }
            }
        ...
        NewMaterialButton {
            ...
            onClicked: {
                ...
                UtilsAdapter.setToDefault(Settings.Key.AppColorTheme);
