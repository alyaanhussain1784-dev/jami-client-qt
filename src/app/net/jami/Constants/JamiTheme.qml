...
Item {
    ...
    property string colorTheme: UtilsAdapter.getAppValue(Settings.Key.AppColorTheme)
    ...
    Connections {
        ...
        function onAppThemeChanged() {
            ...
            colorTheme = UtilsAdapter.getAppValue(Settings.Key.AppColorTheme);
        }
    }
    ...
    property color lightTintedBlue: colorTheme === "Emerald" ? "#10B981" : (colorTheme === "Purple" ? "#A855F7" : "#03B9E9")
    property color darkTintedBlue: colorTheme === "Emerald" ? "#059669" : (colorTheme === "Purple" ? "#7C3AED" : "#005699")
    ...
    property color selectionBlue: darkTheme
        ? (colorTheme === "Emerald" ? "#047857" : (colorTheme === "Purple" ? "#6D28D9" : "#0061a5"))
        : (colorTheme === "Emerald" ? "#34D399" : (colorTheme === "Purple" ? "#C084FC" : "#109ede"))
    ...
    property color editLineColor: tintedBlue
    property color buttonTintedBlue: tintedBlue
    property color buttonTintedBlueHovered: darkTheme
        ? (colorTheme === "Emerald" ? "#10B981" : (colorTheme === "Purple" ? "#B877F8" : "#039CC4"))
        : (colorTheme === "Emerald" ? "#047857" : (colorTheme === "Purple" ? "#6D28D9" : "#0071c9"))
    property color buttonTintedBlueInternalHover: Qt.rgba(darkTintedBlue.r, darkTintedBlue.g, darkTintedBlue.b, 0.2)
    property color buttonTintedBluePressed: darkTheme
        ? (colorTheme === "Emerald" ? "#059669" : (colorTheme === "Purple" ? "#7C3AED" : "#0071c9"))
        : (colorTheme === "Emerald" ? "#065F46" : (colorTheme === "Purple" ? "#5B21B6" : "#005699"))
    ...
    property color declineRed: rgba256(204, 0, 34, 100)
    property color declineRedTransparent: rgba256(204, 0, 34, 56)
    ...
    property color secondaryButtonBorderColor: darkTheme
        ? (colorTheme === "Emerald" ? "#065F46" : (colorTheme === "Purple" ? "#4C1D95" : "#1D5F70"))
        : (colorTheme === "Emerald" ? "#A7F3D0" : (colorTheme === "Purple" ? "#DDD6FE" : "#A3C2DA"))
    property color secondaryButtonHoveredBorderColor: tintedBlue
    property color secAndTertiHoveredBackgroundColor: darkTheme
        ? (colorTheme === "Emerald" ? "#064E3B" : (colorTheme === "Purple" ? "#3B0764" : "#123F4A"))
        : (colorTheme === "Emerald" ? "#ECFDF5" : (colorTheme === "Purple" ? "#F5F3FF" : "#E5EEF5"))
    ...
    // Jami switch
    property color switchBackgroundCheckedColor: darkTheme
        ? (colorTheme === "Emerald" ? "#059669" : (colorTheme === "Purple" ? "#7C3AED" : "#005699"))
        : (colorTheme === "Emerald" ? "#A7F3D0" : (colorTheme === "Purple" ? "#DDD6FE" : "#8dbaea"))
    property color switchBackgroundColor: darkTheme ? "#626262" : "#E5EEF5"
    property color switchBackgroundBorderColor: darkTheme ? "#4d4d4d" : secondaryButtonBorderColor
    ...
    property color switchHandleCheckedBorderColor: darkTintedBlue
    ...
    property color comboboxBorderColor: secondaryButtonBorderColor
    property color comboboxIconColor: tintedBlue
    property color comboboxBackgroundColorHovered: secAndTertiHoveredBackgroundColor
    property color comboboxTextColor: tintedBlue
    ...
    property color chatViewFooterSendButtonColor: tintedBlue
    ...
    property color sharePositionIndicatorColor: tintedBlue
    ...
    property int chatViewFadeDuration: 750
    ...
    property color welcomeBlockColor: darkTheme ? "#A8000000" : "#A8EEEEEE"
    ...
    property real sidePanelTopPaddingMac: 22
    ...
    property real messageBarSpacing: 4
    ...
    property real newMaterialButtonSetupHeight: 48
    ...
    // TextField
    property real newMaterialTextFieldBackgroundColor: darkTheme ? JamiTheme.backgroundColor : "#BDBDBD"
