...
Item {
    ...
    property string rendezVous: qsTr("Convert account into rendezvous point")
    ...
    property string selectNewRingtone: qsTr("Select new ringtone")
    ...
    // AppAccessPage
    property string appAccessSettingsTitle: qsTr("App access")
    property string appAccessSettingsDescription: qsTr("Manage how external applications, bots, or scripts can access this account through the local API.")
    property string appAccessEnableServerButton: qsTr("Enable server")
    property string appAccessServerDisabledTitle: qsTr("Local API server disabled")
    property string appAccessServerDisabledMessage: qsTr("The local API server is disabled in application settings. Enable it to generate and manage API tokens for this account.")
    property string appAccessTokenLabelPlaceholder: qsTr("Token label (e.g. my-bot)")
    property string appAccessCreateToken: qsTr("Generate token")
    property string appAccessTokensListTitle: qsTr("Active tokens")
    property string appAccessNoTokens: qsTr("No API tokens configured for this account.")
    property string appAccessTokenCreatedAt: qsTr("Created %1")
    property string appAccessTokenExpiresAt: qsTr("Expires %1")
    property string appAccessTokenCreatedTitle: qsTr("API token created")
    property string appAccessTokenCreatedMessage: qsTr("Copy this token now. It will not be shown again.")
    property string appAccessTokenCopyWarning: qsTr("This token grants access to your account. Keep it secret.")
    property string appAccessBotAccounts: qsTr("Bot Accounts")
    property string appAccessCreateBotAccount: qsTr("Create Bot")
    property string appAccessBotHelp: qsTr("How do bots work?")
    ...
    // SharedServicesSettingsPage
    property string sharedServicesSettingsTitle: qsTr("Shared services")
    property string sharedServicesDescription: qsTr("Expose local TCP services or a local folder over Jami so trusted contacts can reach them as if they were running on their own machine.")
    property string sharedServicesListTitle: qsTr("Shared services")
    property string sharedServicesNone: qsTr("No services are shared yet.")
    property string sharedServicesNameLabel: qsTr("Name")
    property string sharedServicesNamePlaceholder: qsTr("e.g. webhook, ssh, syncthing")
    property string sharedServicesDescriptionLabel: qsTr("Description (optional)")
    property string sharedServicesTypeLabel: qsTr("Type")
    property string sharedServicesTypeCustom: qsTr("Custom")
    property string sharedServicesTypeEmbeddedWebServer: qsTr("Web server (embedded)")
    property string sharedServicesDirectoryLabel: qsTr("Directory")
    ...
    property string sharedServicesPreferredPortUseServicePort: qsTr("Use local port as preferred port on peers")
    ...
    property string sharedServicesCustomSchemeLabel: qsTr("URI scheme (optional)")
    property string sharedServicesPolicyLabel: qsTr("Accessible by")
    property string sharedServicesPolicyContacts: qsTr("Contacts")
    property string sharedServicesPolicyPublic: qsTr("Anyone (public)")
    property string sharedServicesPolicySpecific: qsTr("Specific contacts only")
    property string sharedServicesAllowedLabel: qsTr("Allowed contact URIs (comma-separated)")
    property string sharedServicesEnabled: qsTr("Enabled")
    property string sharedServicesSave: qsTr("Save")
    property string sharedServicesLocalEndpoint: qsTr("Local endpoint: %1")
    property string sharedServicesDirectory: qsTr("Directory: %1")
    property string sharedServicesDisabled: qsTr("Disabled")
    property string sharedServicesOpenUrl: qsTr("Open %1")
    property string sharedServicesCopyEndpoint: qsTr("Copy %1")
    property string sharedServicesPolicyTagPublic: qsTr("Public")
    property string sharedServicesPolicyTagContacts: qsTr("Contacts")
    property string sharedServicesPolicyTagSpecific: qsTr("Specific")
    property string sharedServicesConfirmDelete: qsTr("Are you sure you want to delete this shared service?")
    property string sharedServicesAddWebsite: qsTr("Add website")
    property string sharedServicesCustomService: qsTr("Custom service")
    property string sharedServicesWhatsThis: qsTr("What's this?")
    property string sharedServicesUriSchemeDetails: qsTr("Enter the URI scheme to use when accessing the service (e.g. http, https, etc…)")
    property string sharedServicesConnect: qsTr("Connect")
    property string sharedServicesDisconnect: qsTr("Disconnect")
    property string sharedServicesOpenInExternalBrowser: qsTr("Open in external browser")
    property string sharedServicesUnavailable: qsTr("Device unavailable")
    property string sharedServicesConnectFailed: qsTr("Connection failed")

    // SharedServicesSection / contact details
    property string sharedServicesSectionTitle: qsTr("Shared services")
    property string sharedServicesEmpty: qsTr("This contact does not expose any service to you.")
    property string sharedServicesNoDevices: qsTr("No devices found for this contact. They may be offline.")
    property string sharedServicesUnreachable: qsTr("Could not reach any of this contact's devices.")
    property string sharedServicesTimeout: qsTr("This contact's device did not respond in time.")
    property string sharedServicesInternalError: qsTr("Service discovery is unavailable on this account.")
    property string sharedServicesRefresh: qsTr("Refresh")
    ...
    property string systemApplicationTitle: qsTr("Application")
    property string systemLanguageTitle: qsTr("Language")
    ...
    property string conferenceResolution: qsTr("Conference resolution")
    property string groupCallsAndConferences: qsTr("Group calls and conferences")
    ...
    property string openKeypad: qsTr("Show keypad")
    ...
    property string chooseAUsername: qsTr("Choose username")
    ...
    property string chooseUsernameForRV: qsTr("Choose rendezvous point name")
    property string chooseAName: qsTr("Choose name")
    ...
    property string passwordOptional: qsTr("Protecting the account with a password is optional, and if the password is lost it CANNOT be recovered later.")
    ...
    property string tipBackupAccount: qsTr("Back up the account to a .jac file")
    ...
    property string encryptAccount: qsTr("Set account password")
    ...
    // LinkedDevices
    property string tipLinkNewDevice: qsTr("Link new device to this account")
    ...
    property string selectFolder: qsTr("Select folder")
    ...
    property string systemApiEnableServer: qsTr("Enable local API server")
    property string systemApiEnableServerTooltip: qsTr("Start a local HTTP server that external applications can use to interact with Jami")
    property string systemApiServerSectionTitle: qsTr("Local API server")
    property string systemApiServerInfoTitle: qsTr("API access is managed per account")
    property string systemApiServerInfoMessage: qsTr("Configure the local server here, then open App access in the current account settings to create and revoke tokens.")
    property string systemApiOpenAppAccess: qsTr("Open App access")
    property string systemApiServerPort: qsTr("Server port")
    property string systemApiServerRunning: qsTr("Server running on port %1")
    property string systemApiServerStopped: qsTr("Server stopped")
    ...
    property string passwordArchive: qsTr("If the account is password protected, please fill the following field.")
    ...
    property string enterPasswordPinCode: qsTr("This account is password protected, enter the password to generate PIN code.")
    ...
    property string shiftEnterNewLine: qsTr("Press Shift+Enter to insert new line")
    property string enterNewLine: qsTr("Press Enter to insert new line")
    ...
    property string showOriginalMessage: qsTr("Show original")
    property string showModifiedMessage: qsTr("Show modified")
    property string modifiedByExtension: qsTr("Modified by extension")
    ...
    property string customizeText: qsTr("Add profile picture and nickname to complete your profile")
    ...
    // CreateAccount
    property string encryptWithPassword: qsTr("Set account password")
    property string customizeYourProfile: qsTr("Customize profile")
    ...
    property string textFormattingDescription: qsTr("Enter or Shift+Enter to insert new line")
    ...
    property string presenceStatus: qsTr("Status %1")
    property string oneToOnePresenceOnline: qsTr("Online")
    property string oneToOnePresenceOffline: qsTr("Offline")
    property string swarmPresenceOnline: qsTr("At least one person is online")
    property string swarmPresenceOffline: qsTr("Everyone is offline")
    property string incomingAndOutgoingShareLocation: qsTr("You and %1 are sharing locations with each other")
